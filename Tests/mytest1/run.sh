...
mkdir -p /output/mytest1
mkdir -p /tmp/sol
mkdir -p /output/mytest1/sol
...
$LLVM_BIN/opt -load $LLVM_SO/CSE231.so -cse231-csi < /tmp/test1-c.ll > /dev/null 2> /output/mytest1/csi.result
...
/tmp/cdi_test1 2> /output/mytest1/cdi.result
/tmp/bb_test1 2> /output/mytest1/bb.result



# solution by prof
/solution/opt -cse231-csi < /tmp/test1-c.ll > /dev/null 2> /output/mytest1/sol/csi.result
...
/tmp/sol/cdi_test1 2> /output/mytest1/sol/cdi.result
/tmp/sol/bb_test1 2> /output/mytest1/sol/bb.result