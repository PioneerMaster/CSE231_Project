...
OUTPUT_DIR=/output/dfa/test_maypointto_analysis
...
${LLVM_BIN}/opt -load ${LLVM_SO}/CSE231.so -cse231-maypointto < ${TEST_DIR}/${LL_NAME} > /dev/null 2> ${OUTPUT_DIR}/${RESULT_NAME}

# solution
/solution/opt -cse231-maypointto < ${TEST_DIR}/${LL_NAME} > /dev/null 2> ${OUTPUTSOL_DIR}/${RESULT_NAME}
