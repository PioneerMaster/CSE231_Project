...
@key_global = internal constant [5 x i32] [i32 2, i32 29, i32 30, i32 31, i32 51]
@val_global = internal constant [5 x i32] [i32 1, i32 2, i32 1, i32 2, i32 1]
@key_global.1 = internal constant [4 x i32] [i32 2, i32 11, i32 30, i32 31]
@val_global.2 = internal constant [4 x i32] [i32 1, i32 1, i32 1, i32 1]
...
@key_global.5 = internal constant [3 x i32] [i32 1, i32 11, i32 30]
@val_global.6 = internal constant [3 x i32] [i32 1, i32 1, i32 2]
...
define i32 @_Z3fooj(i32) #0 {
  ...
  %5 = icmp ugt i32 %4, 5
  call void @updateInstrInfo(i32 5, i32* getelementptr inbounds ([5 x i32], [5 x i32]* @key_global, i32 0, i32 0), i32* getelementptr inbounds ([5 x i32], [5 x i32]* @val_global, i32 0, i32 0))
...
; <label>:6:                                      ; preds = %1
  ...
  call void @updateInstrInfo(i32 4, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @key_global.1, i32 0, i32 0), i32* getelementptr inbounds ([4 x i32], [4 x i32]* @val_global.2, i32 0, i32 0))
  br label %12
