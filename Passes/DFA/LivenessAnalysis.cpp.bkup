...
{
  public:
    LivenessAnalysis(Info &bottom, Info &initialState) : DataFlowAnalysis<Info, Direction>::DataFlowAnalysis(bottom, initialState) {}
...
struct LivenessAnalysisPass : public FunctionPass
{
    ...
    bool runOnFunction(Function &F) override
    {
        ...
        LivenessInfo bot;
        LivenessAnalysis<LivenessInfo, false> la(bot, bot);
        // errs()<<"aa\n";
